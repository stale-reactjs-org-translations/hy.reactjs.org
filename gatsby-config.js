...
module.exports = {
  siteMetadata: {
    title: 'React: JavaScript գրադարան` օգտագործողի ինտերֆեյսներ կառուցելու համար',
    siteUrl: 'https://reactjs.org',
    rssFeedTitle: 'React',
    rssFeedDescription: 'JavaScript գրադարան` օգտագործողի ինտերֆեյսներ կառուցելու համար',
  },
  mapping: {
