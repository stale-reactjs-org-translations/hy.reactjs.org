...
Այս էջը ներկայացնում է վիճակի(state) և կյանքի ցիկլի(lifecycle) գաղափարը React կոմպոնենտում։ Դուք կարող եք գտնել կոմպոնենտի մանրամասն API հղում [այստեղ](/docs/react-component.html)։
...
Մենք [նախկինում](/docs/components-and-props.html#functional-and-class-components) նշել էինք, որ կոմպոնենտները հայտարարված, որպես կլասներ, ունեն մի քանի լրացուցիչ հնարավորություններ։ Լոկալ state-ը հենց դա է. հատկություն հասանելի միայն կլասներում։
