...
Այս գլխում, մենք կսովորենք թե ինչպես պատրաստել `Clock` կոմպոնենտը իսկապես բազմակի օգտագործման ենթակա և ինկապսուլացված։ Այն կտեղադրի իր սեփական Ժամաչափը(timer) և կթարմացնի ինքն իրեն ամեն վայրկյան։
...
`render` մեթոդը կկանչվի ամեն անգամ, երբ թարմացում տեղի ունենա, բայց այնքան ժամանակ մինչդեռ մենք արտապատկերում ենք `<Clock />`-ը նույն DOM հանգույցի մեջ, `Clock` կլասի միայն մեկ ժառանգ կօգտագործվի։ Այն թույլ կտա մեզ օգտագործել մի քանի լրացուցիչ հնարավորություններ, ինչպիսիք են լոկալ state-ը և կյանքի ցիկլի մեթոդները։
...
Ուշադրություն դարձրեք, թե ինչպես ենք փոխանցում `props`-ը հիմնական կոնստրուկորին.
...
Մենք նաև ցանկանում ենք [ջնջել ժամաչափը](https://developer.mozilla.org/en-US/docs/Web/API/WindowTimers/clearInterval)<sub>`eng`</sub> հենց `Clock`-ի կողմից ստեղծված DOM հանգույցը ջնջվի։ Սա React-ում կոչվում է «unmounting»։
...
Մինչդեռ `this.props`-ը տեղադրված է React-ի կողմից և `this.state`-ը ունի հատուկ նշանակություն, դուք ազատ եք ավելացնելու հավելյալ դաշտեր կլասում ինքնուրույն, երբ կարիք ունեք պահելու ինչ-որ բան, որը կապ չունի տվյալների հոսքի հետ (օրինակ ժամաչափի ID-ի նման)։
...
Վերջապես, մենք կիրականացնենք `tick()` անունով մեթոդ, որին `Clock` կոմպոնենտը կկանչի ամեն վայրկյան։
...
Ո'չ ծնող, ո'չ զավակ կոմպոնենտները չեն կարող իմանալ, արդյոք տվյալ կոմպոնենտը վիճակով(stateful) է կամ վիճակազուրկ(stateless), և նրանք չպետք է հոգ տանեն այն բանի մասին, թե դա հայտարարված է որպես ֆունկցիա թե որպես կլաս։

Ահա թե ինչու state-ը հաճախ անվանվում է լոկալ կամ ինկապսուլացված։ Այն հասանելի չէ ուրիշ ոչ մի կոմպոնենտից, բացի այն մեկից, որում հենց ինքն է և որը տեղադրել է իրեն։
