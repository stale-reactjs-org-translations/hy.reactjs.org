...
React-ում պայմանական արտապատկերումը աշխատում է նույն ձեւով ինչ որ պայմանները JavaScript-ում։
Օգտագործեք JavaScript-ի օպերատորներից [`if`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/if...else)-ը կամ [պայմանական օպերատոր](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Operators/Conditional_Operator)-ը որպեսզի ստեղծեք էլեմենտներ, որոնք կներկայացնեն ընթացիկ վիճակը և թույլ կտան React-ին թարմացնել UI-ը համապատասխանեցնելով իրենց։
...
Այն պետք է արտապատկերի `<LoginButton />` կամ `<LogoutButton />` ելնելով իր ներկա վիճակից։ Այն նաև կարտապատկերի `<Greeting />`-ը` նախորդ օրինակից։
...
Իհարկե փոփոխականներ հայտարարելը և `if` օպերատորի օգնությամբ պայմանական արտապատկերելը բավականին լավ տարբերակ է, սակայն կան ավելի կարճ տարբերակներ, որոնք նշված են ստորև օրինակնեում։
...
Միգուցե հազվադեպ դեպքերում ցանկանաք, որ կոմպոնենտը թաքցնի ինքն իրեն ՝ անգամ եթե այն արտապաստկերվել է մեկ այլ կոմպոնենտի կողմից։ Այդ անելու համար ուղակի վերադարձրեք `null` որպես ելքային արժեք։

Ստորև օրինակում `<WarningBanner />`-ը արտապատկերվում է կախված `warn` հատկության արժեքից։ Եթե նրա արժեքը `false` է, ապա կոմպոնենտը չի արտապատկերվի։
