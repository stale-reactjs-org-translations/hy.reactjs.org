...
### Կոմպոնենտի արտապատկերման կանխումը {#preventing-component-from-rendering}

Միգուցե հազվադեպ դեպքերում ցանկանաք, որ կոմպոնենտը թաքցնի ինքն իրեն անգամ եթե այն արտապատկերվել է մեկ այլ կոմպոնենտի կողմից։ Այդ անելու համար ուղակի վերադարձրեք `null` որպես ելքային արժեք։
