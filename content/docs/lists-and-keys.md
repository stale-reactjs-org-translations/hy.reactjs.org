...
Նախ, դիտարկենք, թե ինչպես եք ձևափոխում ցուցակներ JavaScript-ում։

Ստորև բերված կոդում, `թվեր`-ի զանգված վերցնելու և նրանց արժեքները կրկնապատկելու համար, մենք օգտագործում ենք [`map()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map) ֆունկցիան։ Այնուհետև, `doubled` փոփոխականին վերագրում ենք այն ինչ վերադարձվել է `map()` ֆունկցիայի կողմից և տպում ենք այն։
...
React-ում զանգվածների ձևափոխումը [էլեմենտների](/docs/rendering-elements.html) ցուցակների կատարվում է նման եղանակով։

### Մի Քանի Կոմպոնենտների Արտապաատկերում {#rendering-multiple-components}

Դուք կարող եք ստեղծել էլեմենտների հավաքածուներ և օգտագործելով ձևավոր փակագծերը `{}` [ներդնել նրանց JSX-ի մեջ](/docs/introducing-jsx.html#embedding-expressions-in-jsx)։
...
Երբ այս կոդը աշխատացնեք դուք կստանաք զգուշացում այն մասին, որ ցուցակի էլեմենտները պետք է ունենան բանալիներ։ «Բանալին» դա հատուկ տողային ատրիբուտ է, որը պետք է ներառեք էլեմենտների ցուցակ ստեղծելուց։ Թե ինչի համար է դա կարևոր` մենք կքննարկենք հաջորդ բաժնում։
...
Բանալիները React-ին օգնում են տարբերել փոփոխված, ավելացված կամ հեռացված էլեմենտներին։ Բանալիները պետք է փոխանցել էլեմենտներին ՝ նրանց կայուն տարբերակիչ տալու համար։
...
Բանալի ընտրելու լավագույն տարբերակը դա տողային փոփոխականի օգտագործումն է, որը միարժեք կտարբերակի ցուցակի տարրին նրա հարևաններից։ Շատ հաճախ դուք կկոգտագործեք ձեր տվյալների `ID`-ները, որպես բանալի։
...
Խորհուրդ չենք տալիս օգտագործել ինդեքսները որպես բանալիներ այն դեպքում երբ էլեմենտների դասավորությունը կարող է փոխվել։ Այն կարող է բացասական ազդեցություն ունենալ արտադրողականության վրա և խնդիրներ առաջացնել կոմպոնենտի վիճակի հետ։
Կարդացեք Ռոբին Պոկորնեի հոդվածը\` [ինդեքսները, որպես բանալի օգտագործելու բացասական ազդեցությունների խորը բացատրության](https://medium.com/@robinpokorny/index-as-a-key-is-an-anti-pattern-e0349aece318) մասին։ Եթե դուք որոշեք բացահայտորեն չփոխանցել բանալին ցուցակի էլեմենտներին, ապա React-ը`, լռությամբ կօգտագործի ինդեքսները որպես բանալի։
...
### Բանալիները Հարևանների Շարքում Պետք Է Լինեն Ունիկալ {#keys-must-only-be-unique-among-siblings}
...
JSX-ը թույլ է տալիս ձևավոր փակագծերի մեջ [ներդնել ցանկացած արտահայտություն](/docs/introducing-jsx.html#embedding-expressions-in-jsx), այսպիսով մենք կարող ենք տեղադրել `map()`-ից ստացած արդյունքը`
...
Երբեմն, որպես արդյունք, ունենում ենք ավելի մաքուր կոդ, սակայն այս ոճը կարող է չարաշահվել։ Ինչպես JavaScript-ում, ձեր հաեցողության տակ է, որոշել տարանջատել փոփոխականը ավելի ընթերնելի դարձնելու համար, թե ոչ։ Մտապահեք. եթե map()-ի մարմինը բավականին ներդրված է, ապա միգուցե կարիք կա [կոմպոնենտը տարանջատելու](/docs/components-and-props.html#extracting-components)։
