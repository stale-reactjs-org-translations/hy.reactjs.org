...
Երբ այս կոդը աշխատեցնեք, դուք կստանաք զգուշացում այն մասին, որ ցուցակի էլեմենտները պետք է ունենան բանալիներ։ «Բանալին» դա հատուկ տողային ատրիբուտ է, որը պետք է ներառեք էլեմենտների ցուցակ ստեղծելիս։ Թե ինչի համար է դա կարևոր, կքննարկենք հաջորդ բաժնում։
...
Հիմնական սկզբունքն այն է, որ `map()`-ի կանչի մեջ էլեմենտները բանալիների կարիք ունեն։
