...
Առաջին հերթին եկեք տեսնենք թե ինչպես եք ստանում ցուցակներ JavaScript-ում։

Ստորև բերված կոդի օրինակում մենք օգտագործում ենք [`map()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map) ֆունկցիան, որպեսզի վերցնենք `թվեր`-ի զանգված և կրկնապատկենք նրանց արժեքները, այնուհետև `doubled` փոփոխականին վերագրենք նոր զանգված ՝ վերադարձված `map()` ֆունկցիայի կողմից, և տպում ենք այն։
...
React-ում զանգվածների փոփոխությունները [էլեմենտների](/docs/rendering-elements.html) ցուցակների գրեթե նույնն են։

### Բազմաթիվ Կոմպոնենտների Արտապաատկերումը {#rendering-multiple-components}
...
Մենք ողջ `listItems` զանգվածը ներդնում ենք `<ul>` էլեմենտ-ի մեջ և [արտապատկերում այն DOM-ում](/docs/rendering-elements.html#rendering-an-element-into-the-dom). 
...
Սովորաբար դուք պատկերելու եք ցուցակները [կոմպոնենտի](/docs/components-and-props.html) մեջ։
...
Երբ այս կոդը աշխատացնեք դուք կստանաք զգուշացում այն մասին, որ ցուցակի էլեմենտները պետք է ունենան բանալիներ։ "Բանալին" դա հատուկ տողային ատրիբուտ է, որը պետք է ներառեք էլեմենտների ցուցակ ստեղծելուց։ Թե ինչի է դա կարևոր` մենք կքննարկենք հաջորդ բաժնում։
...
Բանալին կցելու լավագույն ձևը դա տողի փոխանցումն է, որը ունիկալ է իր հարևան էլեմենտների մեջ։ Շատ հաճախ դուք կկոգտագործեք ձեր տվյալների `ID`-ները, որպես բանալի. 
...
Բանալիները իմաստ ունեն միայն շրջապատող զանգվածի կոնտեքստում։
...
JSX-ը թույլ է տալիս ձևավոր փակագծերի մեջ [տեղադրել յուրաքանչյուր արտահայտություն](/docs/introducing-jsx.html#embedding-expressions-in-jsx), որով մենք կարող ենք տեղադրել `map()`-ից ստացած արդյունքը`
