...
>
<<<<<<< HEAD
>Մենք խորհուրդ ենք տալիս օգտագործել [«Babel լեզվի սահմանում»](https://babeljs.io/docs/editors)-ը ձեր խմբագրիչի համար, որպեսզի ES6 և JSX կոդերն ընդգծվեն ինչպես հարկն է։ Այս վեբկայքն օգտագործում է [«Oceanic Next»](https://github.com/voronianski/oceanic-next-color-scheme) գունային սխեման, որը համատեղելի է դրա հետ։
=======
